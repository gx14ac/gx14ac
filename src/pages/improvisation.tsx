            ...
            <div className="grid auto-rows-max gap-12">
                <div className="flex flex-col gap-4">
                    <p className={`${fira.className} text-md text-gray-400`}>
                        title: 'gangsta', dec 1, 2023<br />
                    </p>
                    <div className="flex flex-row gap-4 justify-start items-center">
                        <audio src={Gangsta} controls className="text-xs "></audio>
                        <a href={Gangsta} download className="text-xs hover:text-gray-500 underline underline-offset-8">download</a>
                    </div>
                </div>
                <div className="flex flex-col gap-4">
                    <p className={`${fira.className} text-md text-gray-400`}>
