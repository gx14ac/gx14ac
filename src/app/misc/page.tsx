            ...
            <div className="mt-24 sm:ml-8 mini:ml-6 mini:mr-10">
                <div className="flex flex-col gap-5">
                    <div className="flex-row flex items-center gap-6 justify-between">
                        <Link href="/misc/ajisashi" className={`${fira.className} text-xl hover:text-gray-500 underline underline-offset-8`} onClick={() => { }}>
                            ajisashi.
                        </Link>
                    ...
                    <div className="flex-row flex items-center gap-6 justify-between">
                        <Link href="/misc/terrible-japan" className={`${fira.className} text-xl hover:text-gray-500 underline underline-offset-8`} onClick={() => { }}>
                            terrible japan.
                        </Link>
                        <p className={`${fira.className} text-xs text-gray-400`}>
                            mar 10, 2024<br />
